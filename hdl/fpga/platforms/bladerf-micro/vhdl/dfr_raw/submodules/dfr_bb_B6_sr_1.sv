...
// SystemVerilog created from bb_dfr_B6_sr_1
...
module dfr_bb_B6_sr_1 (
    input wire [0:0] in_i_stall,
    input wire [0:0] in_i_valid,
    input wire [0:0] in_i_data_0_tpl,
    input wire [0:0] in_i_data_1_tpl,
    input wire [25:0] in_i_data_2_tpl,
    ...
    output wire [25:0] out_o_data_2_tpl,
    ...
    begin
        if (!resetn)
        begin
            sr_2_x_q <= $unsigned(26'b00000000000000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
