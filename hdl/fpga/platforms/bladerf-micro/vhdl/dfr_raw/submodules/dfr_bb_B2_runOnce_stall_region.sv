...
module dfr_bb_B2_runOnce_stall_region (
    ...
    wire [25:0] i_sfc_s_c0_in_lp_init_end_dfrs_c0_enter54_dfr1_aunroll_x_out_intel_reserved_ffwd_0_0;
    wire [0:0] i_sfc_s_c0_in_lp_init_end_dfrs_c0_enter54_dfr1_aunroll_x_out_o_stall;
    wire [0:0] i_sfc_s_c0_in_lp_init_end_dfrs_c0_enter54_dfr1_aunroll_x_out_o_valid;
    ...
    wire [0:0] SE_out_i_sfc_s_c0_in_lp_init_end_dfrs_c0_enter54_dfr1_aunroll_x_wireValid;
    wire [0:0] SE_out_i_sfc_s_c0_in_lp_init_end_dfrs_c0_enter54_dfr1_aunroll_x_backStall;
    wire [0:0] SE_out_i_sfc_s_c0_in_lp_init_end_dfrs_c0_enter54_dfr1_aunroll_x_V0;


    // SE_out_i_sfc_s_c0_in_lp_init_end_dfrs_c0_enter54_dfr1_aunroll_x(STALLENABLE,30)
    // Valid signal propagation
    assign SE_out_i_sfc_s_c0_in_lp_init_end_dfrs_c0_enter54_dfr1_aunroll_x_V0 = SE_out_i_sfc_s_c0_in_lp_init_end_dfrs_c0_enter54_dfr1_aunroll_x_wireValid;
    // Backward Stall generation
    assign SE_out_i_sfc_s_c0_in_lp_init_end_dfrs_c0_enter54_dfr1_aunroll_x_backStall = in_stall_in | ~ (SE_out_i_sfc_s_c0_in_lp_init_end_dfrs_c0_enter54_dfr1_aunroll_x_wireValid);
    // Computing multiple Valid(s)
    assign SE_out_i_sfc_s_c0_in_lp_init_end_dfrs_c0_enter54_dfr1_aunroll_x_wireValid = i_sfc_s_c0_in_lp_init_end_dfrs_c0_enter54_dfr1_aunroll_x_out_o_valid;

    // i_sfc_s_c0_in_lp_init_end_dfrs_c0_enter54_dfr1_aunroll_x(BLACKBOX,21)@0
    // in in_i_stall@20000000
    // out out_intel_reserved_ffwd_0_0@20000000
    // out out_o_stall@20000000
    // out out_o_valid@19
    // out out_c0_exit55_0_tpl@19
    dfr_i_sfc_s_c0_in_lp_init_end_s_c0_enter54_dfr1 thei_sfc_s_c0_in_lp_init_end_dfrs_c0_enter54_dfr1_aunroll_x (
        .in_i_stall(SE_out_i_sfc_s_c0_in_lp_init_end_dfrs_c0_enter54_dfr1_aunroll_x_backStall),
        .in_i_valid(SE_stall_entry_V1),
        .in_unnamed_dfr3_0_tpl(GND_q),
        .out_intel_reserved_ffwd_0_0(i_sfc_s_c0_in_lp_init_end_dfrs_c0_enter54_dfr1_aunroll_x_out_intel_reserved_ffwd_0_0),
        .out_o_stall(i_sfc_s_c0_in_lp_init_end_dfrs_c0_enter54_dfr1_aunroll_x_out_o_stall),
        .out_o_valid(i_sfc_s_c0_in_lp_init_end_dfrs_c0_enter54_dfr1_aunroll_x_out_o_valid),
        .out_c0_exit55_0_tpl(),
        .clock(clock),
        .resetn(resetn)
    );
    ...
    assign SE_stall_entry_consumed1 = (~ (i_sfc_s_c0_in_lp_init_end_dfrs_c0_enter54_dfr1_aunroll_x_out_o_stall) & SE_stall_entry_wireValid) | SE_stall_entry_fromReg1;
    // Consuming
    ...
    assign out_intel_reserved_ffwd_0_0 = i_sfc_s_c0_in_lp_init_end_dfrs_c0_enter54_dfr1_aunroll_x_out_intel_reserved_ffwd_0_0;

    // sync_out(GPOUT,18)@0
    assign out_stall_out = SE_stall_entry_backStall;

    // dupName_0_sync_out_x(GPOUT,20)@19
    assign out_valid_out = SE_out_i_sfc_s_c0_in_lp_init_end_dfrs_c0_enter54_dfr1_aunroll_x_V0;
