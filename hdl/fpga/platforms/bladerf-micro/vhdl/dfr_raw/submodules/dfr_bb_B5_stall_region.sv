...
module dfr_bb_B5_stall_region (
    ...
    wire [5:0] i_pms_cs1464_dfr0_vt_const_31_q;
    wire [31:0] i_pms_cs1464_dfr0_vt_join_q;
    wire [25:0] i_pms_cs1464_dfr0_vt_select_25_b;
    wire [31:0] i_pms_cs1464_dfr0_sel_x_b;
    ...
    // i_pms_cs1464_dfr0_vt_const_31(CONSTANT,18)
    assign i_pms_cs1464_dfr0_vt_const_31_q = $unsigned(6'b000000);
    ...
    // i_pms_cs1464_dfr0_sel_x(BITSELECT,34)@0
    assign i_pms_cs1464_dfr0_sel_x_b = {6'b000000, bubble_select_stall_entry_c[25:0]};

    // i_pms_cs1464_dfr0_vt_select_25(BITSELECT,20)@0
    assign i_pms_cs1464_dfr0_vt_select_25_b = i_pms_cs1464_dfr0_sel_x_b[25:0];

    // i_pms_cs1464_dfr0_vt_join(BITJOIN,19)@0
    assign i_pms_cs1464_dfr0_vt_join_q = {i_pms_cs1464_dfr0_vt_const_31_q, i_pms_cs1464_dfr0_vt_select_25_b};
    ...
    dfr_i_llvm_fpga_mem_memdep_0 thei_llvm_fpga_mem_memdep_dfr2 (
        ...
        .in_i_writedata(i_pms_cs1464_dfr0_vt_join_q),
