...
module dfr_bb_B6 (
    ...
    wire [0:0] bb_dfr_B6_stall_region_out_c0_exe281;
    wire [0:0] bb_dfr_B6_stall_region_out_c0_exe382;
    ...
    wire [31:0] bb_dfr_B6_stall_region_out_memdep_6_dfr_avm_address;
    wire [0:0] bb_dfr_B6_stall_region_out_memdep_6_dfr_avm_burstcount;
    wire [7:0] bb_dfr_B6_stall_region_out_memdep_6_dfr_avm_byteenable;
    wire [0:0] bb_dfr_B6_stall_region_out_memdep_6_dfr_avm_enable;
    wire [0:0] bb_dfr_B6_stall_region_out_memdep_6_dfr_avm_read;
    wire [0:0] bb_dfr_B6_stall_region_out_memdep_6_dfr_avm_write;
    wire [63:0] bb_dfr_B6_stall_region_out_memdep_6_dfr_avm_writedata;
    ...
    wire [0:0] dfr_B6_branch_out_c0_exe281;
    ...
    wire [0:0] dfr_B6_merge_out_exitcond1048;
    wire [0:0] dfr_B6_merge_out_forked17;
    wire [0:0] dfr_B6_merge_out_memdep_phi7_pop1846;
    wire [0:0] dfr_B6_merge_out_memdep_phi_pop1750;
    wire [0:0] dfr_B6_merge_out_notcmp49;
    wire [25:0] dfr_B6_merge_out_result_i_i16_i47;
    ...
    dfr_B6_merge thedfr_B6_merge (
        .in_exitcond1048_0(in_exitcond1048_0),
        .in_exitcond1048_1(in_exitcond1048_1),
        .in_forked17_0(in_forked17_0),
        .in_forked17_1(in_forked17_1),
        .in_memdep_phi7_pop1846_0(in_memdep_phi7_pop1846_0),
        .in_memdep_phi7_pop1846_1(in_memdep_phi7_pop1846_1),
        .in_memdep_phi_pop1750_0(in_memdep_phi_pop1750_0),
        .in_memdep_phi_pop1750_1(in_memdep_phi_pop1750_1),
        .in_notcmp49_0(in_notcmp49_0),
        .in_notcmp49_1(in_notcmp49_1),
        .in_result_i_i16_i47_0(in_result_i_i16_i47_0),
        .in_result_i_i16_i47_1(in_result_i_i16_i47_1),
        .in_stall_in(bb_dfr_B6_stall_region_out_stall_out),
        .in_valid_in_0(in_valid_in_0),
        .in_valid_in_1(in_valid_in_1),
        .out_exitcond1048(dfr_B6_merge_out_exitcond1048),
        .out_forked17(dfr_B6_merge_out_forked17),
        .out_memdep_phi7_pop1846(dfr_B6_merge_out_memdep_phi7_pop1846),
        .out_memdep_phi_pop1750(dfr_B6_merge_out_memdep_phi_pop1750),
        .out_notcmp49(dfr_B6_merge_out_notcmp49),
        .out_result_i_i16_i47(dfr_B6_merge_out_result_i_i16_i47),
    ...
    dfr_bb_B6_stall_region thebb_dfr_B6_stall_region (
        .in_exitcond1048(dfr_B6_merge_out_exitcond1048),
        .in_flush(in_flush),
        .in_forked17(dfr_B6_merge_out_forked17),
        ...
        .in_memdep_phi7_pop1846(dfr_B6_merge_out_memdep_phi7_pop1846),
        .in_memdep_phi_pop1750(dfr_B6_merge_out_memdep_phi_pop1750),
        .in_notcmp49(dfr_B6_merge_out_notcmp49),
        .in_pipeline_stall_in(in_pipeline_stall_in),
        .in_result_i_i16_i47(dfr_B6_merge_out_result_i_i16_i47),
        ...
        .out_c0_exe281(bb_dfr_B6_stall_region_out_c0_exe281),
        .out_c0_exe382(bb_dfr_B6_stall_region_out_c0_exe382),
        ...
        .out_memdep_6_dfr_avm_address(bb_dfr_B6_stall_region_out_memdep_6_dfr_avm_address),
        .out_memdep_6_dfr_avm_burstcount(bb_dfr_B6_stall_region_out_memdep_6_dfr_avm_burstcount),
        .out_memdep_6_dfr_avm_byteenable(bb_dfr_B6_stall_region_out_memdep_6_dfr_avm_byteenable),
        .out_memdep_6_dfr_avm_enable(bb_dfr_B6_stall_region_out_memdep_6_dfr_avm_enable),
        .out_memdep_6_dfr_avm_read(bb_dfr_B6_stall_region_out_memdep_6_dfr_avm_read),
        .out_memdep_6_dfr_avm_write(bb_dfr_B6_stall_region_out_memdep_6_dfr_avm_write),
        .out_memdep_6_dfr_avm_writedata(bb_dfr_B6_stall_region_out_memdep_6_dfr_avm_writedata),
    ...
    dfr_B6_branch thedfr_B6_branch (
        .in_c0_exe281(bb_dfr_B6_stall_region_out_c0_exe281),
        .in_c0_exe382(bb_dfr_B6_stall_region_out_c0_exe382),
        ...
        .out_c0_exe281(dfr_B6_branch_out_c0_exe281),
    ...
    // out_c0_exe281(GPOUT,30)
    assign out_c0_exe281 = dfr_B6_branch_out_c0_exe281;
    ...
    // out_memdep_6_dfr_avm_address(GPOUT,36)
    assign out_memdep_6_dfr_avm_address = bb_dfr_B6_stall_region_out_memdep_6_dfr_avm_address;

    // out_memdep_6_dfr_avm_burstcount(GPOUT,37)
    assign out_memdep_6_dfr_avm_burstcount = bb_dfr_B6_stall_region_out_memdep_6_dfr_avm_burstcount;

    // out_memdep_6_dfr_avm_byteenable(GPOUT,38)
    assign out_memdep_6_dfr_avm_byteenable = bb_dfr_B6_stall_region_out_memdep_6_dfr_avm_byteenable;

    // out_memdep_6_dfr_avm_enable(GPOUT,39)
    assign out_memdep_6_dfr_avm_enable = bb_dfr_B6_stall_region_out_memdep_6_dfr_avm_enable;

    // out_memdep_6_dfr_avm_read(GPOUT,40)
    assign out_memdep_6_dfr_avm_read = bb_dfr_B6_stall_region_out_memdep_6_dfr_avm_read;

    // out_memdep_6_dfr_avm_write(GPOUT,41)
    assign out_memdep_6_dfr_avm_write = bb_dfr_B6_stall_region_out_memdep_6_dfr_avm_write;

    // out_memdep_6_dfr_avm_writedata(GPOUT,42)
    assign out_memdep_6_dfr_avm_writedata = bb_dfr_B6_stall_region_out_memdep_6_dfr_avm_writedata;
