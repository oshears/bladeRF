...
module dfr_i_sfc_logic_s_c0_in_lp_init_s_c0_enter6_dfr0 (
    ...
    assign i_adder_dfr26_a = {1'b0, redist4_i_llvm_fpga_pop_i5_index_pop11_dfr12_out_data_out_1_q};
    ...
    // i_llvm_fpga_push_i5_index_push11_dfr27(BLACKBOX,45)@3
    ...
    dfr_i_llvm_fpga_push_i5_index_push11_0 thei_llvm_fpga_push_i5_index_push11_dfr27 (
        ...
        .out_data_out(),
        .out_feedback_out_11(i_llvm_fpga_push_i5_index_push11_dfr27_out_feedback_out_11),
        .out_feedback_valid_out_11(i_llvm_fpga_push_i5_index_push11_dfr27_out_feedback_valid_out_11),
        .out_stall_out(),
        .out_valid_out(),
        .clock(clock),
        .resetn(resetn)
    ...
    // i_llvm_fpga_pop_i5_index_pop11_dfr12(BLACKBOX,39)@2
    // out out_feedback_stall_out_11@20000000
    dfr_i_llvm_fpga_pop_i5_index_pop11_0 thei_llvm_fpga_pop_i5_index_pop11_dfr12 (
        .in_data_in(c_i5_045_q),
        .in_dir(redist0_sync_together67_aunroll_x_in_c0_eni1_1_tpl_1_q),
        .in_feedback_in_11(i_llvm_fpga_push_i5_index_push11_dfr27_out_feedback_out_11),
        .in_feedback_valid_in_11(i_llvm_fpga_push_i5_index_push11_dfr27_out_feedback_valid_out_11),
        .in_predicate(GND_q),
        .in_stall_in(GND_q),
        .in_valid_in(valid_fanout_reg4_q),
        .out_data_out(i_llvm_fpga_pop_i5_index_pop11_dfr12_out_data_out),
        .out_feedback_stall_out_11(i_llvm_fpga_pop_i5_index_pop11_dfr12_out_feedback_stall_out_11),
        .out_stall_out(),
        .out_valid_out(),
        .clock(clock),
        .resetn(resetn)
    ...
    // redist4_i_llvm_fpga_pop_i5_index_pop11_dfr12_out_data_out_1(DELAY,133)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            redist4_i_llvm_fpga_pop_i5_index_pop11_dfr12_out_data_out_1_q <= '0;
        end
        else
        begin
            redist4_i_llvm_fpga_pop_i5_index_pop11_dfr12_out_data_out_1_q <= $unsigned(i_llvm_fpga_pop_i5_index_pop11_dfr12_out_data_out);
        end
    end

    // i_zext_dfr13_sel_x(BITSELECT,93)@3
    assign i_zext_dfr13_sel_x_b = {27'b000000000000000000000000000, redist4_i_llvm_fpga_pop_i5_index_pop11_dfr12_out_data_out_1_q[4:0]};
