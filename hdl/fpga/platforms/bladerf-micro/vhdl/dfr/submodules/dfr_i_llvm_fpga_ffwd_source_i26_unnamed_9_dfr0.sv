...
module dfr_i_llvm_fpga_ffwd_source_i26_unnamed_9_dfr0 (
    ...
    input wire [25:0] in_src_data_in_1_0,
    ...
    // element_extension2(BITJOIN,4)@93
    assign element_extension2_q = {c_i6_03_q, in_src_data_in_1_0};

    // i_llvm_fpga_ffwd_source_i26_unnamed_dfr9_dfr1(EXTIFACE,5)@93
    ...
    // dupName_0_sync_out_x(GPOUT,11)@93
