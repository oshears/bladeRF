...
module dfr_bb_B1_runOnce (
    ...
    wire [0:0] bb_dfr_B1_runOnce_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going28_dfr6_exiting_stall_out;
    wire [0:0] bb_dfr_B1_runOnce_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going28_dfr6_exiting_valid_out;
    ...
    wire [0:0] dfr_B1_runOnce_merge_out_forked25;
    ...
    dfr_B1_runOnce_merge thedfr_B1_runOnce_merge (
        ...
        .out_forked25(dfr_B1_runOnce_merge_out_forked25),
    ...
    dfr_bb_B1_runOnce_stall_region thebb_dfr_B1_runOnce_stall_region (
        .in_flush(in_flush),
        .in_forked25(dfr_B1_runOnce_merge_out_forked25),
        ...
        .out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going28_dfr6_exiting_stall_out(bb_dfr_B1_runOnce_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going28_dfr6_exiting_stall_out),
        .out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going28_dfr6_exiting_valid_out(bb_dfr_B1_runOnce_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going28_dfr6_exiting_valid_out),
    ...
    assign out_exiting_stall_out = bb_dfr_B1_runOnce_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going28_dfr6_exiting_stall_out;

    // out_exiting_valid_out(GPOUT,17)
    assign out_exiting_valid_out = bb_dfr_B1_runOnce_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going28_dfr6_exiting_valid_out;
