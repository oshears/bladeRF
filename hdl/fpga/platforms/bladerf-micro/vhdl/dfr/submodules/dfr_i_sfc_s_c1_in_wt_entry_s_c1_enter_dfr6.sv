...
// SystemVerilog created from i_sfc_s_c1_in_wt_entry_dfrs_c1_enter_dfr6
...
module dfr_i_sfc_s_c1_in_wt_entry_s_c1_enter_dfr6 (
    ...
    wire [25:0] i_sfc_logic_s_c1_in_wt_entry_dfrs_c1_enter_dfr0_aunroll_x_out_intel_reserved_ffwd_1_0;
    ...
    // i_llvm_fpga_sfc_exit_s_c1_out_wt_entry_dfrs_c1_exit_dfr1_aunroll_x(BLACKBOX,8)@93
    ...
    // out out_unnamed_dfr10_0_tpl@93
    dfr_i_sfc_logic_s_c1_in_wt_entry_s_c1_enter_dfr0 thei_sfc_logic_s_c1_in_wt_entry_dfrs_c1_enter_dfr0_aunroll_x (
        ...
        .out_intel_reserved_ffwd_1_0(i_sfc_logic_s_c1_in_wt_entry_dfrs_c1_enter_dfr0_aunroll_x_out_intel_reserved_ffwd_1_0),
        .out_o_valid(i_sfc_logic_s_c1_in_wt_entry_dfrs_c1_enter_dfr0_aunroll_x_out_o_valid),
        .out_unnamed_dfr2(),
        .out_unnamed_dfr10_0_tpl(),
        .clock(clock),
        .resetn(resetn)
    );

    // regfree_osync(GPOUT,5)
    assign out_intel_reserved_ffwd_1_0 = i_sfc_logic_s_c1_in_wt_entry_dfrs_c1_enter_dfr0_aunroll_x_out_intel_reserved_ffwd_1_0;
    ...
    // dupName_0_sync_out_aunroll_x(GPOUT,11)@96
