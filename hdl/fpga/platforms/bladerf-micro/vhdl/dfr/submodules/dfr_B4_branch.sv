...
module dfr_B4_branch (
    ...
    input wire [0:0] in_memdep_phi7_pop18,
    ...
    // out_c0_exe167(GPOUT,9)
    assign out_c0_exe167 = in_c0_exe167;

    // out_c0_exe268(GPOUT,10)
    assign out_c0_exe268 = in_c0_exe268;

    // out_c1_exe1(GPOUT,11)
    assign out_c1_exe1 = in_c1_exe1;

    // out_memdep_phi7_pop18(GPOUT,12)
    assign out_memdep_phi7_pop18 = in_memdep_phi7_pop18;
