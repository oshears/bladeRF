...
module dfr_function_wrapper (
    input wire [2047:0] avm_memdep_14_dfr_readdata,
    input wire [0:0] avm_memdep_14_dfr_readdatavalid,
    input wire [0:0] avm_memdep_14_dfr_waitrequest,
    input wire [0:0] avm_memdep_14_dfr_writeack,
    input wire [2047:0] avm_memdep_3_dfr_readdata,
    input wire [0:0] avm_memdep_3_dfr_readdatavalid,
    input wire [0:0] avm_memdep_3_dfr_waitrequest,
    input wire [0:0] avm_memdep_3_dfr_writeack,
    input wire [63:0] avm_memdep_5_dfr_readdata,
    input wire [0:0] avm_memdep_5_dfr_readdatavalid,
    input wire [0:0] avm_memdep_5_dfr_waitrequest,
    input wire [0:0] avm_memdep_5_dfr_writeack,
    ...
    input wire [31:0] avst_iord_bl_call_dfr_data,
    ...
    output wire [31:0] avm_memdep_14_dfr_address,
    output wire [0:0] avm_memdep_14_dfr_burstcount,
    output wire [255:0] avm_memdep_14_dfr_byteenable,
    output wire [0:0] avm_memdep_14_dfr_enable,
    output wire [0:0] avm_memdep_14_dfr_read,
    output wire [0:0] avm_memdep_14_dfr_write,
    output wire [2047:0] avm_memdep_14_dfr_writedata,
    output wire [31:0] avm_memdep_3_dfr_address,
    output wire [0:0] avm_memdep_3_dfr_burstcount,
    output wire [255:0] avm_memdep_3_dfr_byteenable,
    output wire [0:0] avm_memdep_3_dfr_enable,
    output wire [0:0] avm_memdep_3_dfr_read,
    output wire [0:0] avm_memdep_3_dfr_write,
    output wire [2047:0] avm_memdep_3_dfr_writedata,
    output wire [31:0] avm_memdep_5_dfr_address,
    output wire [0:0] avm_memdep_5_dfr_burstcount,
    output wire [7:0] avm_memdep_5_dfr_byteenable,
    output wire [0:0] avm_memdep_5_dfr_enable,
    output wire [0:0] avm_memdep_5_dfr_read,
    output wire [0:0] avm_memdep_5_dfr_write,
    output wire [63:0] avm_memdep_5_dfr_writedata,
    ...
    output wire [0:0] avst_iowr_bl_return_dfr_data,
    ...
    wire [0:0] dfr_function_out_iowr_bl_return_dfr_o_fifodata;
    wire [0:0] dfr_function_out_iowr_bl_return_dfr_o_fifovalid;
    wire [31:0] dfr_function_out_memdep_14_dfr_avm_address;
    wire [0:0] dfr_function_out_memdep_14_dfr_avm_burstcount;
    wire [255:0] dfr_function_out_memdep_14_dfr_avm_byteenable;
    wire [0:0] dfr_function_out_memdep_14_dfr_avm_enable;
    wire [0:0] dfr_function_out_memdep_14_dfr_avm_read;
    wire [0:0] dfr_function_out_memdep_14_dfr_avm_write;
    wire [2047:0] dfr_function_out_memdep_14_dfr_avm_writedata;
    wire [31:0] dfr_function_out_memdep_3_dfr_avm_address;
    wire [0:0] dfr_function_out_memdep_3_dfr_avm_burstcount;
    wire [255:0] dfr_function_out_memdep_3_dfr_avm_byteenable;
    wire [0:0] dfr_function_out_memdep_3_dfr_avm_enable;
    wire [0:0] dfr_function_out_memdep_3_dfr_avm_read;
    wire [0:0] dfr_function_out_memdep_3_dfr_avm_write;
    wire [2047:0] dfr_function_out_memdep_3_dfr_avm_writedata;
    wire [31:0] dfr_function_out_memdep_5_dfr_avm_address;
    wire [0:0] dfr_function_out_memdep_5_dfr_avm_burstcount;
    wire [7:0] dfr_function_out_memdep_5_dfr_avm_byteenable;
    wire [0:0] dfr_function_out_memdep_5_dfr_avm_enable;
    wire [0:0] dfr_function_out_memdep_5_dfr_avm_read;
    wire [0:0] dfr_function_out_memdep_5_dfr_avm_write;
    wire [63:0] dfr_function_out_memdep_5_dfr_avm_writedata;
    ...
    dfr_function thedfr_function (
        ...
        .in_memdep_14_dfr_avm_readdata(avm_memdep_14_dfr_readdata),
        .in_memdep_14_dfr_avm_readdatavalid(avm_memdep_14_dfr_readdatavalid),
        .in_memdep_14_dfr_avm_waitrequest(avm_memdep_14_dfr_waitrequest),
        .in_memdep_14_dfr_avm_writeack(avm_memdep_14_dfr_writeack),
        .in_memdep_3_dfr_avm_readdata(avm_memdep_3_dfr_readdata),
        .in_memdep_3_dfr_avm_readdatavalid(avm_memdep_3_dfr_readdatavalid),
        .in_memdep_3_dfr_avm_waitrequest(avm_memdep_3_dfr_waitrequest),
        .in_memdep_3_dfr_avm_writeack(avm_memdep_3_dfr_writeack),
        .in_memdep_5_dfr_avm_readdata(avm_memdep_5_dfr_readdata),
        .in_memdep_5_dfr_avm_readdatavalid(avm_memdep_5_dfr_readdatavalid),
        .in_memdep_5_dfr_avm_waitrequest(avm_memdep_5_dfr_waitrequest),
        .in_memdep_5_dfr_avm_writeack(avm_memdep_5_dfr_writeack),
        ...
        .out_memdep_14_dfr_avm_address(dfr_function_out_memdep_14_dfr_avm_address),
        .out_memdep_14_dfr_avm_burstcount(dfr_function_out_memdep_14_dfr_avm_burstcount),
        .out_memdep_14_dfr_avm_byteenable(dfr_function_out_memdep_14_dfr_avm_byteenable),
        .out_memdep_14_dfr_avm_enable(dfr_function_out_memdep_14_dfr_avm_enable),
        .out_memdep_14_dfr_avm_read(dfr_function_out_memdep_14_dfr_avm_read),
        .out_memdep_14_dfr_avm_write(dfr_function_out_memdep_14_dfr_avm_write),
        .out_memdep_14_dfr_avm_writedata(dfr_function_out_memdep_14_dfr_avm_writedata),
        .out_memdep_3_dfr_avm_address(dfr_function_out_memdep_3_dfr_avm_address),
        .out_memdep_3_dfr_avm_burstcount(dfr_function_out_memdep_3_dfr_avm_burstcount),
        .out_memdep_3_dfr_avm_byteenable(dfr_function_out_memdep_3_dfr_avm_byteenable),
        .out_memdep_3_dfr_avm_enable(dfr_function_out_memdep_3_dfr_avm_enable),
        .out_memdep_3_dfr_avm_read(dfr_function_out_memdep_3_dfr_avm_read),
        .out_memdep_3_dfr_avm_write(dfr_function_out_memdep_3_dfr_avm_write),
        .out_memdep_3_dfr_avm_writedata(dfr_function_out_memdep_3_dfr_avm_writedata),
        .out_memdep_5_dfr_avm_address(dfr_function_out_memdep_5_dfr_avm_address),
        .out_memdep_5_dfr_avm_burstcount(dfr_function_out_memdep_5_dfr_avm_burstcount),
        .out_memdep_5_dfr_avm_byteenable(dfr_function_out_memdep_5_dfr_avm_byteenable),
        .out_memdep_5_dfr_avm_enable(dfr_function_out_memdep_5_dfr_avm_enable),
        .out_memdep_5_dfr_avm_read(dfr_function_out_memdep_5_dfr_avm_read),
        .out_memdep_5_dfr_avm_write(dfr_function_out_memdep_5_dfr_avm_write),
        .out_memdep_5_dfr_avm_writedata(dfr_function_out_memdep_5_dfr_avm_writedata),
    ...
    // avm_memdep_14_dfr_address(GPOUT,58)
    assign avm_memdep_14_dfr_address = dfr_function_out_memdep_14_dfr_avm_address;

    // avm_memdep_14_dfr_burstcount(GPOUT,59)
    assign avm_memdep_14_dfr_burstcount = dfr_function_out_memdep_14_dfr_avm_burstcount;

    // avm_memdep_14_dfr_byteenable(GPOUT,60)
    assign avm_memdep_14_dfr_byteenable = dfr_function_out_memdep_14_dfr_avm_byteenable;

    // avm_memdep_14_dfr_enable(GPOUT,61)
    assign avm_memdep_14_dfr_enable = dfr_function_out_memdep_14_dfr_avm_enable;

    // avm_memdep_14_dfr_read(GPOUT,62)
    assign avm_memdep_14_dfr_read = dfr_function_out_memdep_14_dfr_avm_read;

    // avm_memdep_14_dfr_write(GPOUT,63)
    assign avm_memdep_14_dfr_write = dfr_function_out_memdep_14_dfr_avm_write;

    // avm_memdep_14_dfr_writedata(GPOUT,64)
    assign avm_memdep_14_dfr_writedata = dfr_function_out_memdep_14_dfr_avm_writedata;

    // avm_memdep_3_dfr_address(GPOUT,65)
    assign avm_memdep_3_dfr_address = dfr_function_out_memdep_3_dfr_avm_address;

    // avm_memdep_3_dfr_burstcount(GPOUT,66)
    assign avm_memdep_3_dfr_burstcount = dfr_function_out_memdep_3_dfr_avm_burstcount;

    // avm_memdep_3_dfr_byteenable(GPOUT,67)
    assign avm_memdep_3_dfr_byteenable = dfr_function_out_memdep_3_dfr_avm_byteenable;

    // avm_memdep_3_dfr_enable(GPOUT,68)
    assign avm_memdep_3_dfr_enable = dfr_function_out_memdep_3_dfr_avm_enable;

    // avm_memdep_3_dfr_read(GPOUT,69)
    assign avm_memdep_3_dfr_read = dfr_function_out_memdep_3_dfr_avm_read;

    // avm_memdep_3_dfr_write(GPOUT,70)
    assign avm_memdep_3_dfr_write = dfr_function_out_memdep_3_dfr_avm_write;

    // avm_memdep_3_dfr_writedata(GPOUT,71)
    assign avm_memdep_3_dfr_writedata = dfr_function_out_memdep_3_dfr_avm_writedata;

    // avm_memdep_5_dfr_address(GPOUT,72)
    assign avm_memdep_5_dfr_address = dfr_function_out_memdep_5_dfr_avm_address;

    // avm_memdep_5_dfr_burstcount(GPOUT,73)
    assign avm_memdep_5_dfr_burstcount = dfr_function_out_memdep_5_dfr_avm_burstcount;

    // avm_memdep_5_dfr_byteenable(GPOUT,74)
    assign avm_memdep_5_dfr_byteenable = dfr_function_out_memdep_5_dfr_avm_byteenable;

    // avm_memdep_5_dfr_enable(GPOUT,75)
    assign avm_memdep_5_dfr_enable = dfr_function_out_memdep_5_dfr_avm_enable;

    // avm_memdep_5_dfr_read(GPOUT,76)
    assign avm_memdep_5_dfr_read = dfr_function_out_memdep_5_dfr_avm_read;

    // avm_memdep_5_dfr_write(GPOUT,77)
    assign avm_memdep_5_dfr_write = dfr_function_out_memdep_5_dfr_avm_write;

    // avm_memdep_5_dfr_writedata(GPOUT,78)
    assign avm_memdep_5_dfr_writedata = dfr_function_out_memdep_5_dfr_avm_writedata;
