...
add wave -noupdate -expand -group ROM /fx3_gpif_tb_dfr/dfr_rom/address
add wave -noupdate -expand -group ROM /fx3_gpif_tb_dfr/dfr_rom/clock
add wave -noupdate -expand -group ROM /fx3_gpif_tb_dfr/dfr_rom/q
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Begin Sample RX} {98890 ns} 1} {{Can RX Samples} {98820 ns} 1} {{RX Finished} {103890 ns} 1} {{Cursor 4} {98941 ns} 0}
...
update
WaveRestoreZoom {98900 ns} {98978 ns}
